...
public class SentDateRangeValidator implements ConstraintValidator<SentDateRangeConstraints, Object> {

		private String fromDate;
	    private String toDate;
		
		@Override
		public void initialize(SentDateRangeConstraints dateRange) {
