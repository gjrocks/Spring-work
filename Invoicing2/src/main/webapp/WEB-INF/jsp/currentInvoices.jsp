...
<body>
	...
	<form:form modelAttribute="currentInvoicesBean" id="searchForm">
							...
							<div class="form-row">
								...
								<div class="col-md-2 ">
									...
									<form:select class="form-control" id="invoiceStatus"
										path="invoiceStatus">
										<form:options items="${currentInvoicesBean.invoiceStatusMap}" />
									</form:select>
								...
								<div class="form-group">
									...
									<div class="col-md-2 ">
										<form:select class="form-control" id="sortBy" path="sortBy">
											<form:options items="${currentInvoicesBean.sortByMap}" />
										</form:select>
								...
								<div class="btn-container ">
									...
									<div class="col-md-1 ">
										<button class=" btn-submit btn btn-primary " name="search"
											formaction="${pageContext.request.contextPath}/searchCurrentInvoices?page=${currentInvoicesBean.page}">Search</button>
									</div>
								</div>
			...
			<c:if test="${showSearchResults==true}">
				...
				<div class="row ">
					...
					<div class="centre-display">
						...
						<div class="col-md-3">
							<div class="row">
								<form:form method="post" modelAttribute="invoiceResultsBean"
									action="/addSentDate">
					...
					<div class="row">
						<div class="centre-display">
							<table class="table table-break-all" id="demo">
								...
								<tbody>
									<c:forEach items="${invoiceResultsList}" var="invoiceResults"
										varStatus="num">
