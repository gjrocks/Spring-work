...
System.out.println(accessToken);
    ...
    private Response obtainAccessToken(String clientId, String username, String password) {
        ...
        return RestAssured.given().auth().preemptive().basic(clientId, "secret").and().with().params(params).when().post("http://localhost:8981/spring-security-oauth-server/oauth/token");
